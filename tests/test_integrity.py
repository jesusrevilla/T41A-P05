...
class TestDatabaseIntegrity(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.cur.execute("""
            ...
            INSERT INTO articulos (codigo_articulo, nombre_articulo, precio_unitario_articulo)
            VALUES ('100', 'Articulo Prueba', 50.00)
        ...
        cls.cur.execute("""
            ...
            INSERT INTO facturas (sucursal, numero_factura, fecha_factura, forma_pago_factura, codigo_cliente, total_factura)
            VALUES ('1', 1, CURRENT_DATE, 'Efectivo', '100', 100.00)
        ...
        cls.cur.execute("""
            ...
            INSERT INTO detalle_factura (sucursal, numero_factura, codigo_articulo, cantidad_articulo, precioUnitario_articulo, subtotal_articulo)
            VALUES ('1', 1, '100', 2, 50.00, 100.00)
    ...
    def test_precio_unitario_integridad(self):
        ...
        self.cur.execute("""
            ...
            UPDATE articulo SET precio_unitario_articulo = 75.00 WHERE codigo_articulo = '100';
        """)
        ...
        self.cur.execute("""
            ...
            WHERE sucursal = '1' AND numero_factura = 1 AND codigo_articulo = '100';
        """)
    ...
    def tearDownClass(cls):
        ...
        cls.cur.execute("DELETE FROM detalle_factura WHERE sucursal = '1' AND numero_factura = 1 AND codigo_articulo = '100';")
        cls.cur.execute("DELETE FROM facturas WHERE sucursal = '1' AND numero_factura = 1;")
        cls.cur.execute("DELETE FROM clientes WHERE codigo_cliente = '100';")
        cls.cur.execute("DELETE FROM articulos WHERE codigo_articulo = '100';")
        cls.cur.close()
        cls.conn.close()
